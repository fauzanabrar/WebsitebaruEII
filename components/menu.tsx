...
export function Menu() {
  ...
  const sessionUser = data as UserSession;
  ...
  return (
    <Menubar
      className="flex items-center justify-between lg:justify-end rounded-none border-b border-none px-2 lg:px-4">
      <div className={"block lg:hidden"}>
        <Sheet>
          <SheetTrigger className={" flex items-center justify-center align-middle"}><LucideMenu
            className={"ml-1 h-6 w-6"}/></SheetTrigger>
            ...
            {sessionUser?.user.role === "admin" && (
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <Link href={"/settings"}>
                    <Button variant={activePath === "settings" ? "secondary" : "ghost"}
